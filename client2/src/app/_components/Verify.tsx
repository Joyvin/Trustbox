        ...
        <div>
            ...
            <div className='w-[80%] mx-auto'>
                ...
                <div className='grid md:grid-cols-2 '>
                    ...
                    <div className="m-5">
                        <h1 className='text-2xl font-bold tracking-tight text-gray-900 dark:text-white mx-3 my-2'>Verify by Link</h1>
                        <input type="email" name="email" id="email" className="mx-3 w-[80%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Scan the QR on a certificate and put the link here" required />
                        <button
                            type="button"
                            className="inline-flex m-3 items-center gap-2 rounded-lg bg-[#24292F] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#24292F]/90 focus:outline-none focus:ring-4 focus:ring-[#24292F]/50 dark:hover:bg-[#050708]/30 dark:focus:ring-gray-500 "
                        >
                            <FileSearch />
                            Submit
                        </button>
